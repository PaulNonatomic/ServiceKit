...
namespace Nonatomic.ServiceKit.Editor.ServiceKitWindow
{
	...
	public class ServiceKitServicesTab : VisualElement
	{
		...
		private List<ServiceKit> _serviceKits = new();
		...
		private void HandleAttachToPanel(AttachToPanelEvent evt)
		{
			...
			foreach (var locator in _serviceKits)
			{
				locator.OnChange += HandleServiceKitChange;
			}
		...
		private void HandleServiceKitChange()
		{
		...
		public void RefreshServices()
		{
			...
			// Force asset database refresh to find any new ServiceKit assets
			AssetDatabase.Refresh();

			// Find all ServiceKit assets
			_serviceKits = FindServiceKitAssets();
		...
		/// <summary>
		///     Finds all ServiceKit assets in the project.
		/// </summary>
		private static List<ServiceKit> FindServiceKitAssets()
		{
			return AssetUtils.FindAssetsByType<ServiceKit>();
		}
