	...
	public class ServiceKitWindow : EditorWindow
	{
		...
		public void CreateGUI()
		{
			...
			var baseStyleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>(
				"Packages/com.nonatomic.servicekit/Editor/ServiceKitWindow/ServiceKitWindowStyles.uss");
			...
			var themeStyleSheet = AssetDatabase.LoadAssetAtPath<StyleSheet>(
				$"Packages/com.nonatomic.servicekit/Editor/ServiceKitWindow/ServiceKitWindowStyles{themeSuffix}.uss");
			...
			_root.AddToClassList("service-kit-window");
			
			_servicesTab = new(ScheduleRefresh);
			_root.Add(_servicesTab);
		}
