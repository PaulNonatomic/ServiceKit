...
namespace Nonatomic.ServiceKit.Editor.ServiceKitWindow
{
	public class ServiceItem : VisualElement
	{
		...
		public ServiceItem(Type serviceType, ServiceRecord serviceRecord, SceneType sceneType = SceneType.Regular)
		{
			...
			RegisterCallbacks(container, serviceRecord);
		}

		// The type name for search purposes
		public string ServiceTypeName { get; }

		private void RegisterCallbacks(VisualElement container, ServiceRecord serviceRecord)
		{
			...
			{
				if (serviceRecord.Instance is MonoBehaviour monoBehaviour)
				{
