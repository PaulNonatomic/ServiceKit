...
namespace Nonatomic.ServiceKit.Editor.Utils
{
	public static class ServiceUtils
	{
		...
		public static SceneInfo GetSceneInfoForService(ServiceRecord service, Type serviceType, ServiceKit serviceKit)
		{
			var recordedSceneName = service.OwningScene.name;

			try
			{
				// Non-MonoBehaviour service
				if (service.Instance is not MonoBehaviour monoBehaviour)
				{
